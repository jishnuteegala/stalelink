...
if (!/^v\d+\.\d+\.\d+(?:-[0-9A-Za-z.-]+)?$/.test(tag || "")) {
  throw new Error("usage: node scripts/bootstrap-npm.js vX.Y.Z");
}
...
try {
  ...
  else console.log("Configure npm trusted publishing: package stalelink, repository jishnuteegala/stalelink, workflow .github/workflows/release.yml.");
} finally {
